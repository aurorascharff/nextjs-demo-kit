...
export function Slide({
  ...
  return (
    <div
      className={cn(
        'relative flex h-dvh w-dvw flex-col justify-center gap-8 px-12 py-20 sm:px-24 md:px-32 lg:px-40',
...
export function SlideSplitLayout({
  ...
  return (
    <div className={cn('relative flex h-dvh w-dvw', className)}>
      <div className="border-foreground/10 pointer-events-none absolute inset-4 border sm:inset-6" aria-hidden />
...
export function SlideCode({ children, className, title }: { children: string; className?: string; title?: string }) {
  ...
  return (
    <div className={cn('w-full max-w-2xl', className)}>
      ...
      <pre className="border-foreground/10 bg-foreground/[0.03] text-code-text overflow-x-auto border p-6 text-left font-mono text-[13px] leading-[1.7] sm:text-sm">
